...
class ContactCouncilForm extends Component {
  ...
  render() {
    return (
      <form name="contact-council" className="form-inline"
        method="post"
        action="/thanks-council/"
        data-netlify="true"
        data-netlify-honeypot="bot-field"
        onSubmit={this.handleSubmit}
      >
        <input type="hidden" name="form-name" value="contact-council" />
        <p hidden>
          <label>
            Don’t fill this out:{" "}
        ...
        <div className="form-group row p-3 p-md-4 container ContactCouncilForm">
          <h5 className="col-12 mb-3">
            Tell your City Council Member they should prioritize Affordable Housing
          </h5>
