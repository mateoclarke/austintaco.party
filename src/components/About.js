...
const About = ({  }) => (
  <div className="container py-5" id="about">
    ...
    <p>
      I'm going to collect all of my receipts and match the amount I spend on tacos to donate to two organizations that are reunifying families who have been separated at the border, <a href="https://www.raicestexas.org/">RAICES Texas</a> & <a href="https://texascivilrightsproject.org/">Texas Civil Rights Project</a>. You should too.
    </p>
    <p>
