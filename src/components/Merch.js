        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="col-md-8 col-xs-12 pt-5 pt-md-0">
              <p>
                For a minimum donation of $10, order a custom-designed, handmade pin to commemorate Tour de Taco. All of the proceeds will be donated to Grassroots Leadership & Texas Civil Rights Project.
              </p>
              <p>
